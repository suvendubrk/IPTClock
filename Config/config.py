...
fps = 100 # used for timer to set update frequency
...
leftSponsImagePath = './Images/Sponsors/Side-IPT-NS-full.jpg' #./Images/Sponsors/sponsors.png' # './testPicture.gif'  # './ponyAndDuck.gif'
